...
from seesaw.models.utils import load_model_from_config, load_reports
from seesaw.utils.helpers import load_dataset_column
...
def get_numer_scaler(
    ...
    scaler_type = config.dataset_config.feature_scaling.scaler_type
