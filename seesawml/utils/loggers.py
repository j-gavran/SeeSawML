...
def setup_logger(
    ...
    **kwargs: Any,
    ...
    import lightning_utilities.core.rank_zero as _rz_module

    _original_info = _rz_module._info

    def _filtered_info(*args: Any, **kwargs: Any) -> None:
        if args and "💡 Tip" in str(args[0]):
            return
        _original_info(*args, **kwargs)

    _rz_module._info = _filtered_info
