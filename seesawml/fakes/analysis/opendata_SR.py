...
from seesawml.fakes.analysis.ratio_closure import BinnedFakeFactorIndexer
from seesawml.fakes.dataset.hdf5_converter import AbsEtaProcessor, CrackVetoProcessor
from seesawml.fakes.dataset.hdf5_opendata_converter import (
    LeptonProcessor,
    METProcessor,
    NJetsProcessor,
    OpendataMetadata,
...
from seesawml.utils.dsid_store import DSIDStore
from seesawml.utils.helpers import load_dataset_column_from_config, setup_analysis_dirs
from seesawml.utils.loggers import setup_logger
from seesawml.utils.plots_utils import get_color
...
class FakeFactorProcessor(Processor):
    ...
    def _get_categ_scaler(
        ...
        categ_scaler_type = dataset_config.feature_scaling.get("categ_scaler_type", None)
        scaler_path = dataset_config.feature_scaling.save_path

        categ_scaler = CategoricalFeatureScaler(categ_scaler_type, save_path=scaler_path).load(
            column_names=numer_column_names, postfix="events_0", extra_hash=extra_hash
        )
