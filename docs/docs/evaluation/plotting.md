...
!!! Tip "Signal vs Background Plotting"
...
!!! Note "Multi-class Classification Projections in 2D"
...
Pairwise features plotting. Use `plot_pairwise --help` to see available options.
